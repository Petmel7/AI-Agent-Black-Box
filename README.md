...
AI Agent Black Box is an evidence and quality layer for AI-generated code. The repository contains the monorepo foundation, canonical version 1 evidence contracts, the PostgreSQL evidence-persistence foundation, and the authenticated idempotent ingestion write path. Queue relay and later processing behavior are intentionally not implemented yet.
